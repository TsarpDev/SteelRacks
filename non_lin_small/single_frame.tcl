...
###################################################################################################
	...
	set massX [expr 20387*$kg*0.01];	#500 kg at each top node
...
# generate built up columns: akreo (x2)
	...
	set N_box		9;							# total number of x boxes
	...
	set Special_Boxes { "" "" };				# first column the index of the box, second the vertical lengths of each;
