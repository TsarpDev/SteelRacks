proc_ref	x_column_NL_FULLY_TRUSS	{ Region_ID   *masses *heights  x0  h0 *columns *beams *bracings    {big_x 0} {imp 200} {Node_ID 1000} {Ele_ID 1000}  {InternalNode_ID 1000  } {nIntPt 3} {maxIters 20} {tolIter 1.e-8} } {
...
#         Generate Beam Bracing             #
	...
	for	{set j 1} {$j < $N_col} {incr j} {
		...
		for {set i 1} {$i < $N_box} {incr i} {
			...
			element truss $current_ele $node_i  $node_j $A_beam 210 
			#element elasticBeamColumn	$current_ele  	$node_i  $node_j  $A_beam $Es $I_beam 0;
