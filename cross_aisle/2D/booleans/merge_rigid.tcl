proc_ref merge_rigid {	Master_ID Slave_ID 	{ Negligible 1e-3 } {rigidID 10000000} } {

	set rigido 9999
	uniaxialMaterial Elastic $rigido [expr 210*$GPa]
...
#            Now merge                      #
	...
	foreach a $common {
		set m [lindex $a 0];
		set s [lindex $a 1];
		element zeroLength [expr $i+$rigidID*$Master_ID*$Slave_ID] $m $s -mat $rigido $rigido $rigido -dir  1 2 3   
		puts "Applying ZeroLength in nodes $m and $s";
		incr i;
	}
