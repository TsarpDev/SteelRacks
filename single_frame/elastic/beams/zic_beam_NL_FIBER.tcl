proc_ref	zic_beam_NL_FIBER	{ Region_ID  beams  trusses  massX   *lengths_sym  {h0_start 1.0} {h0_end 1.1}  {x0 0.0}  {y0 0.0}  {Node_ID 1000} {Ele_ID 1000}  {InternalNode_ID 1000  } {nIntPt 3} {maxIters 20} {tolIter 1.e-8} } {
...
#         Generate Vertical Bracing         #
	...
	for	{set j 1} {$j <= [expr $total_nodes-1] } {incr j 2} {
		...
		element nonlinearBeamColumn   $current_ele  $node_i $node_j $nIntPt  $sectionTag  0 -iter $maxIters $tolIter
