...
proc_ref	frameFiberBracing2D	{ Region_ID  frame_ID  *brYpoints *brXpoints *bracings {double "mono"} {imp 0} {Node_ID 100} {Ele_ID 1000}  {InternalNode_ID 100  } {InternalEle_ID 100  } {nIntPt 3} {maxIters 20} {tolIter 1.e-8} } {

	kill_if_3D "ERROR: frameFiberBracing2D is only for 2D analysis. Change analysis type.";
