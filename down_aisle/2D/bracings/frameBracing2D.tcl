...
proc_ref	frameBracing2D	{ Region_ID  frame_ID  *brYpoints *brXpoints *bracings {double "mono"} {imp 0} {Node_ID 100} {Ele_ID 1000}  {InternalNode_ID 100  } {InternalEle_ID 100  } } {

	kill_if_3D "ERROR: frameBracing2D is only for 2D analysis. Change analysis type.";
