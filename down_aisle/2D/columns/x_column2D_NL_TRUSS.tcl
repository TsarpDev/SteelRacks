...
proc_ref	x_column2D_NL_TRUSS	{ Region_ID   *masses *heights  x0  h0 *columns *beams *bracings  release    {big_x 0} {imp 200} {Node_ID 1000} {Ele_ID 1000}  {InternalNode_ID 1000  } {nIntPt 3} {maxIters 20} {tolIter 1.e-8} } {

	kill_if_3D "ERROR: x_column2D_NL_TRUSS is only for 2D analysis. Change analysis type.";
