#################################################################
#################### GUI_frame2D_ElasticCol_LumpedBeam ##############
#################################################################
...
proc_ref	GUI_frame2D_ElasticCol_LumpedBeam	{ Region_ID   *masses *Ypoints  *Xpoints x0 *frame release {Node_ID 100} {Ele_ID 1000}  {InternalNode_ID 100  } {InternalEle_ID 100  } } {

	kill_if_3D "ERROR: GUI_frame2D_ElasticCol_LumpedBeam is only for 2D analysis. Change analysis type.";
